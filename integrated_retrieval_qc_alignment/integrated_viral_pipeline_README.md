...
The integrated pipeline executes the following scripts in order:
...
alignments/*_aligned.fasta
      ...
      |                           |
      v                           v
pairwise_identity.py      analyze_conservation.py
      |                           |
      v                           v
identity_results/         conservation_results/
```

The integrated runner stops if a required stage fails or if an expected
...
```
## Notes
- Readme generated by GPT 5.6 Sol, script co-authored by Milana Djonovic, Tony Isebe, Sachin Kumar, GPT 5.6 Sol.